	...
	<div class="row">
		<div class="col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="login-panel panel panel-default">
				<div class="panel-heading text-center"><div class="bg-info">
					Log in
				</div></div>
					...
					<form role="form" method="post">
						<fieldset>
							...
							<div class="form-group">
								<input required class="form-control" placeholder="Email đăng nhập..." name="email" type="email" value="{{old('email')}}" autofocus="">
							</div>
							<div class="form-group">
